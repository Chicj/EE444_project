...
#define ADC10SHT_0          (0*0x100) /* ADC10 Sample Hold Select 0 */
#define ADC10SHT_1          (1*0x100) /* ADC10 Sample Hold Select 1 */
#define ADC10SHT_2          (2*0x100) /* ADC10 Sample Hold Select 2 */
#define ADC10SHT_3          (3*0x100) /* ADC10 Sample Hold Select 3 */
#define ADC10SHT_4          (4*0x100) /* ADC10 Sample Hold Select 4 */
#define ADC10SHT_5          (5*0x100) /* ADC10 Sample Hold Select 5 */
#define ADC10SHT_6          (6*0x100) /* ADC10 Sample Hold Select 6 */
#define ADC10SHT_7          (7*0x100) /* ADC10 Sample Hold Select 7 */
#define ADC10SHT_8          (8*0x100) /* ADC10 Sample Hold Select 8 */
#define ADC10SHT_9          (9*0x100) /* ADC10 Sample Hold Select 9 */
#define ADC10SHT_10         (10*0x100) /* ADC10 Sample Hold Select 10 */
#define ADC10SHT_11         (11*0x100) /* ADC10 Sample Hold Select 11 */
#define ADC10SHT_12         (12*0x100) /* ADC10 Sample Hold Select 12 */
#define ADC10SHT_13         (13*0x100) /* ADC10 Sample Hold Select 13 */
#define ADC10SHT_14         (14*0x100) /* ADC10 Sample Hold Select 14 */
#define ADC10SHT_15         (15*0x100) /* ADC10 Sample Hold Select 15 */
...
#define ADC10CONSEQ_0        (0*2)      /* ADC10 Conversion Sequence Select: 0 */
#define ADC10CONSEQ_1        (1*2)      /* ADC10 Conversion Sequence Select: 1 */
#define ADC10CONSEQ_2        (2*2)      /* ADC10 Conversion Sequence Select: 2 */
#define ADC10CONSEQ_3        (3*2)      /* ADC10 Conversion Sequence Select: 3 */

#define ADC10SSEL_0          (0*8)      /* ADC10 Clock Source Select: 0 */
#define ADC10SSEL_1          (1*8)      /* ADC10 Clock Source Select: 1 */
#define ADC10SSEL_2          (2*8)      /* ADC10 Clock Source Select: 2 */
#define ADC10SSEL_3          (3*8)      /* ADC10 Clock Source Select: 3 */
...
#define ADC10SHS_0           (0*0x400)  /* ADC10 Sample/Hold Source: 0 */
#define ADC10SHS_1           (1*0x400)  /* ADC10 Sample/Hold Source: 1 */
#define ADC10SHS_2           (2*0x400)  /* ADC10 Sample/Hold Source: 2 */
#define ADC10SHS_3           (3*0x400)  /* ADC10 Sample/Hold Source: 3 */
...
#define ADC10SREF_0         (0*0x10)    /* ADC10 Select Reference 0 */
#define ADC10SREF_1         (1*0x10)    /* ADC10 Select Reference 1 */
#define ADC10SREF_2         (2*0x10)    /* ADC10 Select Reference 2 */
#define ADC10SREF_3         (3*0x10)    /* ADC10 Select Reference 3 */
#define ADC10SREF_4         (4*0x10)    /* ADC10 Select Reference 4 */
#define ADC10SREF_5         (5*0x10)    /* ADC10 Select Reference 5 */
#define ADC10SREF_6         (6*0x10)    /* ADC10 Select Reference 6 */
#define ADC10SREF_7         (7*0x10)    /* ADC10 Select Reference 7 */
...
#define DMA0TSEL_0          (0*0x0001)  /* DMA channel 0 transfer select 0 */
#define DMA0TSEL_1          (1*0x0001)  /* DMA channel 0 transfer select 1 */
#define DMA0TSEL_2          (2*0x0001)  /* DMA channel 0 transfer select 2 */
#define DMA0TSEL_3          (3*0x0001)  /* DMA channel 0 transfer select 3 */
#define DMA0TSEL_4          (4*0x0001)  /* DMA channel 0 transfer select 4 */
#define DMA0TSEL_5          (5*0x0001)  /* DMA channel 0 transfer select 5 */
#define DMA0TSEL_6          (6*0x0001)  /* DMA channel 0 transfer select 6 */
#define DMA0TSEL_7          (7*0x0001)  /* DMA channel 0 transfer select 7 */
#define DMA0TSEL_8          (8*0x0001)  /* DMA channel 0 transfer select 8 */
#define DMA0TSEL_9          (9*0x0001)  /* DMA channel 0 transfer select 9 */
#define DMA0TSEL_10         (10*0x0001) /* DMA channel 0 transfer select 10 */
#define DMA0TSEL_11         (11*0x0001) /* DMA channel 0 transfer select 11 */
#define DMA0TSEL_12         (12*0x0001) /* DMA channel 0 transfer select 12 */
#define DMA0TSEL_13         (13*0x0001) /* DMA channel 0 transfer select 13 */
#define DMA0TSEL_14         (14*0x0001) /* DMA channel 0 transfer select 14 */
#define DMA0TSEL_15         (15*0x0001) /* DMA channel 0 transfer select 15 */
#define DMA0TSEL_16         (16*0x0001) /* DMA channel 0 transfer select 16 */
#define DMA0TSEL_17         (17*0x0001) /* DMA channel 0 transfer select 17 */
#define DMA0TSEL_18         (18*0x0001) /* DMA channel 0 transfer select 18 */
#define DMA0TSEL_19         (19*0x0001) /* DMA channel 0 transfer select 19 */
#define DMA0TSEL_20         (20*0x0001) /* DMA channel 0 transfer select 20 */
#define DMA0TSEL_21         (21*0x0001) /* DMA channel 0 transfer select 21 */
#define DMA0TSEL_22         (22*0x0001) /* DMA channel 0 transfer select 22 */
#define DMA0TSEL_23         (23*0x0001) /* DMA channel 0 transfer select 23 */
#define DMA0TSEL_24         (24*0x0001) /* DMA channel 0 transfer select 24 */
#define DMA0TSEL_25         (25*0x0001) /* DMA channel 0 transfer select 25 */
#define DMA0TSEL_26         (26*0x0001) /* DMA channel 0 transfer select 26 */
#define DMA0TSEL_27         (27*0x0001) /* DMA channel 0 transfer select 27 */
#define DMA0TSEL_28         (28*0x0001) /* DMA channel 0 transfer select 28 */
#define DMA0TSEL_29         (29*0x0001) /* DMA channel 0 transfer select 29 */
#define DMA0TSEL_30         (30*0x0001) /* DMA channel 0 transfer select 30 */
#define DMA0TSEL_31         (31*0x0001) /* DMA channel 0 transfer select 31 */

#define DMA1TSEL_0          (0*0x0100)  /* DMA channel 1 transfer select 0 */
#define DMA1TSEL_1          (1*0x0100)  /* DMA channel 1 transfer select 1 */
#define DMA1TSEL_2          (2*0x0100)  /* DMA channel 1 transfer select 2 */
#define DMA1TSEL_3          (3*0x0100)  /* DMA channel 1 transfer select 3 */
#define DMA1TSEL_4          (4*0x0100)  /* DMA channel 1 transfer select 4 */
#define DMA1TSEL_5          (5*0x0100)  /* DMA channel 1 transfer select 5 */
#define DMA1TSEL_6          (6*0x0100)  /* DMA channel 1 transfer select 6 */
#define DMA1TSEL_7          (7*0x0001)  /* DMA channel 1 transfer select 7 */
#define DMA1TSEL_8          (8*0x0001)  /* DMA channel 1 transfer select 8 */
#define DMA1TSEL_9          (9*0x0100)  /* DMA channel 1 transfer select 9 */
#define DMA1TSEL_10         (10*0x0100) /* DMA channel 1 transfer select 10 */
#define DMA1TSEL_11         (11*0x0100) /* DMA channel 1 transfer select 11 */
#define DMA1TSEL_12         (12*0x0100) /* DMA channel 1 transfer select 12 */
#define DMA1TSEL_13         (13*0x0100) /* DMA channel 1 transfer select 13 */
#define DMA1TSEL_14         (14*0x0100) /* DMA channel 1 transfer select 14 */
#define DMA1TSEL_15         (15*0x0100) /* DMA channel 1 transfer select 15 */
#define DMA1TSEL_16         (16*0x0100) /* DMA channel 1 transfer select 16 */
#define DMA1TSEL_17         (17*0x0100) /* DMA channel 1 transfer select 17 */
#define DMA1TSEL_18         (18*0x0100) /* DMA channel 1 transfer select 18 */
#define DMA1TSEL_19         (19*0x0100) /* DMA channel 1 transfer select 19 */
#define DMA1TSEL_20         (20*0x0100) /* DMA channel 1 transfer select 20 */
#define DMA1TSEL_21         (21*0x0100) /* DMA channel 1 transfer select 21 */
#define DMA1TSEL_22         (22*0x0100) /* DMA channel 1 transfer select 22 */
#define DMA1TSEL_23         (23*0x0100) /* DMA channel 1 transfer select 23 */
#define DMA1TSEL_24         (24*0x0100) /* DMA channel 1 transfer select 24 */
#define DMA1TSEL_25         (25*0x0100) /* DMA channel 1 transfer select 25 */
#define DMA1TSEL_26         (26*0x0100) /* DMA channel 1 transfer select 26 */
#define DMA1TSEL_27         (27*0x0100) /* DMA channel 1 transfer select 27 */
#define DMA1TSEL_28         (28*0x0100) /* DMA channel 1 transfer select 28 */
#define DMA1TSEL_29         (29*0x0100) /* DMA channel 1 transfer select 29 */
#define DMA1TSEL_30         (30*0x0100) /* DMA channel 1 transfer select 30 */
#define DMA1TSEL_31         (31*0x0100) /* DMA channel 1 transfer select 31 */

#define DMA2TSEL_0          (0*0x0001)  /* DMA channel 2 transfer select 0 */
#define DMA2TSEL_1          (1*0x0001)  /* DMA channel 2 transfer select 1 */
#define DMA2TSEL_2          (2*0x0001)  /* DMA channel 2 transfer select 2 */
#define DMA2TSEL_3          (3*0x0001)  /* DMA channel 2 transfer select 3 */
#define DMA2TSEL_4          (4*0x0001)  /* DMA channel 2 transfer select 4 */
#define DMA2TSEL_5          (5*0x0001)  /* DMA channel 2 transfer select 5 */
#define DMA2TSEL_6          (6*0x0001)  /* DMA channel 2 transfer select 6 */
#define DMA2TSEL_7          (7*0x0001)  /* DMA channel 2 transfer select 7 */
#define DMA2TSEL_8          (8*0x0001)  /* DMA channel 2 transfer select 8 */
#define DMA2TSEL_9          (9*0x0001)  /* DMA channel 2 transfer select 9 */
#define DMA2TSEL_10         (10*0x0001) /* DMA channel 2 transfer select 10 */
#define DMA2TSEL_11         (11*0x0001) /* DMA channel 2 transfer select 11 */
#define DMA2TSEL_12         (12*0x0001) /* DMA channel 2 transfer select 12 */
#define DMA2TSEL_13         (13*0x0001) /* DMA channel 2 transfer select 13 */
#define DMA2TSEL_14         (14*0x0001) /* DMA channel 2 transfer select 14 */
#define DMA2TSEL_15         (15*0x0001) /* DMA channel 2 transfer select 15 */
#define DMA2TSEL_16         (16*0x0001) /* DMA channel 2 transfer select 16 */
#define DMA2TSEL_17         (17*0x0001) /* DMA channel 2 transfer select 17 */
#define DMA2TSEL_18         (18*0x0001) /* DMA channel 2 transfer select 18 */
#define DMA2TSEL_19         (19*0x0001) /* DMA channel 2 transfer select 19 */
#define DMA2TSEL_20         (20*0x0001) /* DMA channel 2 transfer select 20 */
#define DMA2TSEL_21         (21*0x0001) /* DMA channel 2 transfer select 21 */
#define DMA2TSEL_22         (22*0x0001) /* DMA channel 2 transfer select 22 */
#define DMA2TSEL_23         (23*0x0001) /* DMA channel 2 transfer select 23 */
#define DMA2TSEL_24         (24*0x0001) /* DMA channel 2 transfer select 24 */
#define DMA2TSEL_25         (25*0x0001) /* DMA channel 2 transfer select 25 */
#define DMA2TSEL_26         (26*0x0001) /* DMA channel 2 transfer select 26 */
#define DMA2TSEL_27         (27*0x0001) /* DMA channel 2 transfer select 27 */
#define DMA2TSEL_28         (28*0x0001) /* DMA channel 2 transfer select 28 */
#define DMA2TSEL_29         (29*0x0001) /* DMA channel 2 transfer select 29 */
#define DMA2TSEL_30         (30*0x0001) /* DMA channel 2 transfer select 30 */
#define DMA2TSEL_31         (31*0x0001) /* DMA channel 2 transfer select 31 */

#define DMA0TSEL__DMA_REQ   (0*0x0001)  /* DMA channel 0 transfer select 0:  DMA_REQ (sw) */
#define DMA0TSEL__TA0CCR0   (1*0x0001)  /* DMA channel 0 transfer select 1:  Timer0_A (TA0CCR0.IFG) */
#define DMA0TSEL__TA0CCR1   (2*0x0001)  /* DMA channel 0 transfer select 2:  Timer0_A (TA0CCR1.IFG) */
#define DMA0TSEL__TA1CCR0   (3*0x0001)  /* DMA channel 0 transfer select 3:  Timer1_A (TA1CCR0.IFG) */
#define DMA0TSEL__RES4      (4*0x0001)  /* DMA channel 0 transfer select 4:  Reserved */
#define DMA0TSEL__TA2CCR0   (5*0x0001)  /* DMA channel 0 transfer select 5:  Timer2_A (TA2CCR0.IFG) */
#define DMA0TSEL__RES6      (6*0x0001)  /* DMA channel 0 transfer select 6:  Reserved */
#define DMA0TSEL__TA3CCR0   (7*0x0001)  /* DMA channel 0 transfer select 7:  Timer3_A (TA3CCR0.IFG) */
#define DMA0TSEL__RES8      (8*0x0001)  /* DMA channel 0 transfer select 8:  Reserved */
#define DMA0TSEL__RES9      (9*0x0001)  /* DMA channel 0 transfer select 9:  Reserved */
#define DMA0TSEL__RES10     (10*0x0001) /* DMA channel 0 transfer select 10: Reserved */
#define DMA0TSEL__RES11     (11*0x0001) /* DMA channel 0 transfer select 11: Reserved */
#define DMA0TSEL__RES12     (12*0x0001) /* DMA channel 0 transfer select 12: Reserved */
#define DMA0TSEL__SD24IFG   (13*0x0001) /* DMA channel 0 transfer select 13: SD24IFG */
#define DMA0TSEL__RES14     (14*0x0001) /* DMA channel 0 transfer select 14: Reserved */
#define DMA0TSEL__RES15     (15*0x0001) /* DMA channel 0 transfer select 15: Reserved */
#define DMA0TSEL__USCIA0RX  (16*0x0001) /* DMA channel 0 transfer select 16: USCIA0 receive */
#define DMA0TSEL__USCIA0TX  (17*0x0001) /* DMA channel 0 transfer select 17: USCIA0 transmit */
#define DMA0TSEL__USCIA1RX  (18*0x0001) /* DMA channel 0 transfer select 18: USCIA1 receive */
#define DMA0TSEL__USCIA1TX  (19*0x0001) /* DMA channel 0 transfer select 19: USCIA1 transmit */
#define DMA0TSEL__USCIA2RX  (20*0x0001) /* DMA channel 0 transfer select 20: USCIA2 receive */
#define DMA0TSEL__USCIA2TX  (21*0x0001) /* DMA channel 0 transfer select 21: USCIA2 transmit */
#define DMA0TSEL__USCIB0RX  (22*0x0001) /* DMA channel 0 transfer select 22: USCIB0 receive */
#define DMA0TSEL__USCIB0TX  (23*0x0001) /* DMA channel 0 transfer select 23: USCIB0 transmit */
#define DMA0TSEL__ADC10IFG0 (24*0x0001) /* DMA channel 0 transfer select 24: ADC10IFG0 */
#define DMA0TSEL__USCIA3RX  (25*0x0001) /* DMA channel 0 transfer select 25: USCIA3 receive */
#define DMA0TSEL__USCIA3TX  (26*0x0001) /* DMA channel 0 transfer select 26: USCIA3 transmit */
#define DMA0TSEL__USCIB1RX  (27*0x0001) /* DMA channel 0 transfer select 27: USCIB1 receive */
#define DMA0TSEL__USCIB1TX  (28*0x0001) /* DMA channel 0 transfer select 28: USCIB1 transmit */
#define DMA0TSEL__MPY       (29*0x0001) /* DMA channel 0 transfer select 29: Multiplier ready */
#define DMA0TSEL__DMA2IFG   (30*0x0001) /* DMA channel 0 transfer select 30: previous DMA channel DMA2IFG */
#define DMA0TSEL__DMAE0     (31*0x0001) /* DMA channel 0 transfer select 31: ext. Trigger (DMAE0) */

#define DMA1TSEL__DMA_REQ   (0*0x0100)  /* DMA channel 1 transfer select 0:  DMA_REQ (sw) */
#define DMA1TSEL__TA0CCR0   (1*0x0100)  /* DMA channel 1 transfer select 1:  Timer0_A (TA0CCR0.IFG) */
#define DMA1TSEL__TA0CCR1   (2*0x0100)  /* DMA channel 1 transfer select 2:  Timer0_A (TA0CCR1.IFG) */
#define DMA1TSEL__TA1CCR0   (3*0x0100)  /* DMA channel 1 transfer select 3:  Timer1_A (TA1CCR0.IFG) */
#define DMA1TSEL__RES4      (4*0x0100)  /* DMA channel 1 transfer select 4:  Reserved */
#define DMA1TSEL__TA2CCR0   (5*0x0100)  /* DMA channel 1 transfer select 5:  Timer2_A (TA2CCR0.IFG) */
#define DMA1TSEL__RES6      (6*0x0100)  /* DMA channel 1 transfer select 6:  Reserved */
#define DMA1TSEL__TA3CCR0   (7*0x0001)  /* DMA channel 1 transfer select 7:  Timer3_A (TA3CCR0.IFG) */
#define DMA1TSEL__RES8      (8*0x0001)  /* DMA channel 1 transfer select 8:  Reserved */
#define DMA1TSEL__RES9      (9*0x0100)  /* DMA channel 1 transfer select 9:  Reserved */
#define DMA1TSEL__RES10     (10*0x0100) /* DMA channel 1 transfer select 10: Reserved */
#define DMA1TSEL__RES11     (11*0x0100) /* DMA channel 1 transfer select 11: Reserved */
#define DMA1TSEL__RES12     (12*0x0100) /* DMA channel 1 transfer select 12: Reserved */
#define DMA1TSEL__SD24IFG   (13*0x0100) /* DMA channel 1 transfer select 13: SD24IFG */
#define DMA1TSEL__RES14     (14*0x0100) /* DMA channel 1 transfer select 14: Reserved */
#define DMA1TSEL__RES15     (15*0x0100) /* DMA channel 1 transfer select 15: Reserved */
#define DMA1TSEL__USCIA0RX  (16*0x0100) /* DMA channel 1 transfer select 16: USCIA0 receive */
#define DMA1TSEL__USCIA0TX  (17*0x0100) /* DMA channel 1 transfer select 17: USCIA0 transmit */
#define DMA1TSEL__USCIA1RX  (18*0x0100) /* DMA channel 1 transfer select 18: USCIA1 receive */
#define DMA1TSEL__USCIA1TX  (19*0x0100) /* DMA channel 1 transfer select 19: USCIA1 transmit */
#define DMA1TSEL__USCIA2RX  (20*0x0100) /* DMA channel 1 transfer select 20: USCIA2 receive */
#define DMA1TSEL__USCIA2TX  (21*0x0100) /* DMA channel 1 transfer select 21: USCIA2 transmit */
#define DMA1TSEL__USCIB0RX  (22*0x0100) /* DMA channel 1 transfer select 22: USCIB0 receive */
#define DMA1TSEL__USCIB0TX  (23*0x0100) /* DMA channel 1 transfer select 23: USCIB0 transmit */
#define DMA1TSEL__ADC10IFG0 (24*0x0100) /* DMA channel 1 transfer select 24: ADC10IFG0 */
#define DMA1TSEL__USCIA3RX  (25*0x0100) /* DMA channel 1 transfer select 25: USCIA3 receive */
#define DMA1TSEL__USCIA3TX  (26*0x0100) /* DMA channel 1 transfer select 26: USCIA3 transmit */
#define DMA1TSEL__USCIB1RX  (27*0x0100) /* DMA channel 1 transfer select 27: USCIB1 receive */
#define DMA1TSEL__USCIB1TX  (28*0x0100) /* DMA channel 1 transfer select 28: USCIB1 transmit */
#define DMA1TSEL__MPY       (29*0x0100) /* DMA channel 1 transfer select 29: Multiplier ready */
#define DMA1TSEL__DMA0IFG   (30*0x0100) /* DMA channel 1 transfer select 30: previous DMA channel DMA0IFG */
#define DMA1TSEL__DMAE0     (31*0x0100) /* DMA channel 1 transfer select 31: ext. Trigger (DMAE0) */

#define DMA2TSEL__DMA_REQ   (0*0x0001)  /* DMA channel 2 transfer select 0:  DMA_REQ (sw) */
#define DMA2TSEL__TA0CCR0   (1*0x0001)  /* DMA channel 2 transfer select 1:  Timer0_A (TA0CCR0.IFG) */
#define DMA2TSEL__TA0CCR1   (2*0x0001)  /* DMA channel 2 transfer select 2:  Timer0_A (TA0CCR1.IFG) */
#define DMA2TSEL__TA1CCR0   (3*0x0001)  /* DMA channel 2 transfer select 3:  Timer1_A (TA1CCR0.IFG) */
#define DMA2TSEL__RES4      (4*0x0001)  /* DMA channel 2 transfer select 4:  Reserved */
#define DMA2TSEL__TA2CCR0   (5*0x0001)  /* DMA channel 2 transfer select 5:  Timer2_A (TA2CCR0.IFG) */
#define DMA2TSEL__RES6      (6*0x0001)  /* DMA channel 2 transfer select 6:  Reserved */
#define DMA2TSEL__TA3CCR0   (7*0x0001)  /* DMA channel 2 transfer select 7:  Timer3_A (TA3CCR0.IFG) */
#define DMA2TSEL__RES8      (8*0x0001)  /* DMA channel 2 transfer select 8:  Reserved */
#define DMA2TSEL__RES9      (9*0x0001)  /* DMA channel 2 transfer select 9:  Reserved */
#define DMA2TSEL__RES10     (10*0x0001) /* DMA channel 2 transfer select 10: Reserved */
#define DMA2TSEL__RES11     (11*0x0001) /* DMA channel 2 transfer select 11: Reserved */
#define DMA2TSEL__RES12     (12*0x0001) /* DMA channel 2 transfer select 12: Reserved */
#define DMA2TSEL__SD24IFG   (13*0x0001) /* DMA channel 2 transfer select 13: SD24IFG */
#define DMA2TSEL__RES14     (14*0x0001) /* DMA channel 2 transfer select 14: Reserved */
#define DMA2TSEL__RES15     (15*0x0001) /* DMA channel 2 transfer select 15: Reserved */
#define DMA2TSEL__USCIA0RX  (16*0x0001) /* DMA channel 2 transfer select 16: USCIA0 receive */
#define DMA2TSEL__USCIA0TX  (17*0x0001) /* DMA channel 2 transfer select 17: USCIA0 transmit */
#define DMA2TSEL__USCIA1RX  (18*0x0001) /* DMA channel 2 transfer select 18: USCIA1 receive */
#define DMA2TSEL__USCIA1TX  (19*0x0001) /* DMA channel 2 transfer select 19: USCIA1 transmit */
#define DMA2TSEL__USCIA2RX  (20*0x0001) /* DMA channel 2 transfer select 20: USCIA2 receive */
#define DMA2TSEL__USCIA2TX  (21*0x0001) /* DMA channel 2 transfer select 21: USCIA2 transmit */
#define DMA2TSEL__USCIB0RX  (22*0x0001) /* DMA channel 2 transfer select 22: USCIB0 receive */
#define DMA2TSEL__USCIB0TX  (23*0x0001) /* DMA channel 2 transfer select 23: USCIB0 transmit */
#define DMA2TSEL__ADC10IFG0 (24*0x0001) /* DMA channel 2 transfer select 24: ADC10IFG0 */
#define DMA2TSEL__USCIA3RX  (25*0x0001) /* DMA channel 2 transfer select 25: USCIA3 receive */
#define DMA2TSEL__USCIA3TX  (26*0x0001) /* DMA channel 2 transfer select 26: USCIA3 transmit */
#define DMA2TSEL__USCIB1RX  (27*0x0001) /* DMA channel 2 transfer select 27: USCIB1 receive */
#define DMA2TSEL__USCIB1TX  (28*0x0001) /* DMA channel 2 transfer select 28: USCIB1 transmit */
#define DMA2TSEL__MPY       (29*0x0001) /* DMA channel 2 transfer select 29: Multiplier ready */
#define DMA2TSEL__DMA1IFG   (30*0x0001) /* DMA channel 2 transfer select 30: previous DMA channel DMA1IFG */
#define DMA2TSEL__DMAE0     (31*0x0001) /* DMA channel 2 transfer select 31: ext. Trigger (DMAE0) */
...
const sfrb SUMEXT_L       = SUMEXT_;
const sfrb SUMEXT_H       = SUMEXT_+1;
...
#define PAIN_                 (0x0200)  
const sfrb PAIN_L         = PAIN_;
const sfrb PAIN_H         = PAIN_+1;
...
#define PBIN_                 (0x0220)  
const sfrb PBIN_L         = PBIN_;
const sfrb PBIN_H         = PBIN_+1;
const sfrw PBIN           = PBIN_;
...
#define PCIN_                 (0x0240)  
const sfrb PCIN_L         = PCIN_;
const sfrb PCIN_H         = PCIN_+1;
const sfrw PCIN           = PCIN_;
...
#define PDIN_                 (0x0260)  
const sfrb PDIN_L         = PDIN_;
const sfrb PDIN_H         = PDIN_+1;
const sfrw PDIN           = PDIN_;
...
#define PEIN_                 (0x0280)  
const sfrb PEIN_L         = PEIN_;
const sfrb PEIN_H         = PEIN_+1;
const sfrw PEIN           = PEIN_;
...
#define PFIN_                 (0x02A0)  
const sfrb PFIN_L         = PFIN_;
const sfrb PFIN_H         = PFIN_+1;
const sfrw PFIN           = PFIN_;
...
#define PJIN_                 (0x0320)  
const sfrb PJIN_L         = PJIN_;
const sfrb PJIN_H         = PJIN_+1;
const sfrw PJIN           = PJIN_;
...
const sfrb UCA0RXBUF_L    = UCA0RXBUF_;
const sfrb UCA0RXBUF_H    = UCA0RXBUF_+1;
const sfrw UCA0RXBUF      = UCA0RXBUF_;
...
#define UCA1RXBUF_            (0x05EC)  
const sfrb UCA1RXBUF_L    = UCA1RXBUF_;
const sfrb UCA1RXBUF_H    = UCA1RXBUF_+1;
const sfrw UCA1RXBUF      = UCA1RXBUF_;
#define UCA1TXBUF_            (0x05EE)  
...
#define UCA2RXBUF_            (0x060C)  
const sfrb UCA2RXBUF_L    = UCA2RXBUF_;
const sfrb UCA2RXBUF_H    = UCA2RXBUF_+1;
const sfrw UCA2RXBUF      = UCA2RXBUF_;
#define UCA2TXBUF_            (0x060E)  
...
#define UCA3RXBUF_            (0x062C)  
const sfrb UCA3RXBUF_L    = UCA3RXBUF_;
const sfrb UCA3RXBUF_H    = UCA3RXBUF_+1;
const sfrw UCA3RXBUF      = UCA3RXBUF_;
#define UCA3TXBUF_            (0x062E)  
...
#define AES_VECTOR          (36 * 2) /* 0xFFC8 AES */
#define COMP_B_VECTOR       (37 * 2) /* 0xFFCA Comparator B */
#define RTC_VECTOR          (38 * 2) /* 0xFFCC RTC */
#define LCD_C_VECTOR        (39 * 2) /* 0xFFCE LCD C */
#define TIMER3_A1_VECTOR    (40 * 2) /* 0xFFD0 Timer3_A2 CC1, TA */
#define TIMER3_A0_VECTOR    (41 * 2) /* 0xFFD2 Timer3_A2 CC0 */
#define PORT2_VECTOR        (42 * 2) /* 0xFFD4 Port 2 */
#define TIMER2_A1_VECTOR    (43 * 2) /* 0xFFD6 Timer2_A2 CC1, TA */
#define TIMER2_A0_VECTOR    (44 * 2) /* 0xFFD8 Timer2_A2 CC0 */
#define PORT1_VECTOR        (45 * 2) /* 0xFFDA Port 1 */
#define USCI_B1_VECTOR      (46 * 2) /* 0xFFDC USCI B1 Receive/Transmit */
#define USCI_A3_VECTOR      (47 * 2) /* 0xFFDE USCI A3 Receive/Transmit */
#define TIMER1_A1_VECTOR    (48 * 2) /* 0xFFE0 Timer1_A2 CC1, TA1 */
#define TIMER1_A0_VECTOR    (49 * 2) /* 0xFFE2 Timer1_A2 CC0 */
#define DMA_VECTOR          (50 * 2) /* 0xFFE4 DMA */
#define AUX_VECTOR          (51 * 2) /* 0xFFE6 AUX Supply */
#define USCI_A2_VECTOR      (52 * 2) /* 0xFFE8 USCI A2 Receive/Transmit */
#define USCI_A1_VECTOR      (53 * 2) /* 0xFFEA USCI A1 Receive/Transmit */
#define TIMER0_A1_VECTOR    (54 * 2) /* 0xFFEC Timer0_A2 CC1-CC2, TA */
#define TIMER0_A0_VECTOR    (55 * 2) /* 0xFFEE Timer0_A2 CC0 */
#define SD24B_VECTOR        (56 * 2) /* 0xFFF0 SD24B ADC */
#define ADC10_VECTOR        (57 * 2) /* 0xFFF2 ADC */
#define USCI_B0_VECTOR      (58 * 2) /* 0xFFF4 USCI B0 Receive/Transmit */
#define USCI_A0_VECTOR      (59 * 2) /* 0xFFF6 USCI A0 Receive/Transmit */
#define WDT_VECTOR          (60 * 2) /* 0xFFF8 Watchdog Timer */
#define UNMI_VECTOR         (61 * 2) /* 0xFFFA User Non-maskable */
#define SYSNMI_VECTOR       (62 * 2) /* 0xFFFC System Non-maskable */
#define RESET_VECTOR        (63 * 2) /* 0xFFFE Reset [Highest Priority] */
